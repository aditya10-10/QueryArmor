...
namespace QueryGuard.Config
{
    /// <summary>
    /// Persistent configuration for QueryGuard.
    /// Stored at %APPDATA%\QueryGuard\config.json
